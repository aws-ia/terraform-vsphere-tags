...
The vSphere tags Terraform module either creates or reads in a [tag category][category] as well as a list of [tags][tags] in your [VMware vSphere][vsphere] environment (including [VMware Cloud on AWS][vmconaws]), and then outputs the configuration of both for use in other Terraform projects.
